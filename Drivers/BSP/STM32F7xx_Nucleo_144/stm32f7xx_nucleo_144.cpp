...
uint32_t stm32f7xx_nucleo_144::GetVersion(void)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LED_Init(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LED_DeInit(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LED_On(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LED_Off(Led_TypeDef Led)
{
  HAL_GPIO_WritePin(LED_PORT[Led], LED_PIN[Led], GPIO_PIN_RESET);
}
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LED_Toggle(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  GPIO_InitTypeDef GPIO_InitStruct;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::PB_DeInit(Button_TypeDef Button)
{
    GPIO_InitTypeDef gpio_init_structure;
...
/**
  ...
  */
uint32_t stm32f7xx_nucleo_144::PB_GetState(Button_TypeDef Button)
{
  return HAL_GPIO_ReadPin(BUTTON_PORT[Button], BUTTON_PIN[Button]);
}


void stm32f7xx_nucleo_144::digitalSet(uint16_t pin)
{
	HAL_GPIO_WritePin(GPIO_PORT[pin], GPIO_PIN[pin], GPIO_PIN_SET);
}


void stm32f7xx_nucleo_144::PinSet(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
	HAL_GPIO_WritePin(GPIOx, GPIO_Pin, GPIO_PIN_SET);
}

void stm32f7xx_nucleo_144::digitalReset(uint16_t pin)
{
	HAL_GPIO_WritePin(GPIO_PORT[pin], GPIO_PIN[pin], GPIO_PIN_SET);
}

void stm32f7xx_nucleo_144::PinReset(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
	HAL_GPIO_WritePin(GPIOx, GPIO_Pin, GPIO_PIN_RESET);
}

GPIO_PinState stm32f7xx_nucleo_144::digitalRead(uint16_t pin)
{
	return HAL_GPIO_ReadPin(GPIO_PORT[pin], GPIO_PIN[pin]);
}

GPIO_PinState stm32f7xx_nucleo_144::PinRead(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
	return HAL_GPIO_ReadPin(GPIOx, GPIO_Pin);
}

void stm32f7xx_nucleo_144::digitalWrite(uint16_t pin, GPIO_PinState PinState)
{
	HAL_GPIO_WritePin(GPIO_PORT[pin], GPIO_PIN[pin], PinState);
}


void stm32f7xx_nucleo_144::PinWrite(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, GPIO_PinState PinState)
{
	HAL_GPIO_WritePin(GPIOx, GPIO_Pin, PinState);
}

void stm32f7xx_nucleo_144::digitalToggle(uint16_t pin)
{
	HAL_GPIO_TogglePin(GPIO_PORT[pin], GPIO_PIN[pin]);
}

void stm32f7xx_nucleo_144::TogglePin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SPIx_MspInit(SPI_HandleTypeDef *hspi)
{
  GPIO_InitTypeDef  GPIO_InitStruct;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SPIx_Init(void)
{
	// TODO: Set-up for PLC
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SPIx_WriteReadData(const uint8_t *DataIn, uint8_t *DataOut, uint16_t DataLegnth)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SPIx_Write(uint8_t Value)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint8_t data;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SPIx_Error (void)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SD_IO_Init(void)
{
  GPIO_InitTypeDef  GPIO_InitStruct;
  uint8_t counter;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SD_IO_CSState(uint8_t val)
{
  if(val == 1)
  {
    SD_CS_HIGH();
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::SD_IO_WriteReadData(const uint8_t *DataIn, uint8_t *DataOut, uint16_t DataLength)
{
  /* Send the byte */
...
/**
  ...
  * @retval None
  */
uint8_t stm32f7xx_nucleo_144::SD_IO_WriteByte(uint8_t Data)
{
  uint8_t tmp;
  /* Send the byte */
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LCD_IO_Init(void)
{
  GPIO_InitTypeDef  GPIO_InitStruct;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LCD_IO_WriteReg(uint8_t LCDReg)
{
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LCD_IO_WriteData(uint8_t Data)
{
  /* Reset LCD control line CS */
  LCD_CS_LOW();
...
* @retval None
*/
void stm32f7xx_nucleo_144::LCD_IO_WriteMultipleData(uint8_t *pData, uint32_t Size)
{
  uint32_t counter = 0;
...
/**
  ...
  * @retval None
  */
void stm32f7xx_nucleo_144::LCD_Delay(uint32_t Delay)
{
  HAL_Delay(Delay);
}
...
/**
  ...
  * @retval None
  */
static void stm32f7xx_nucleo_144::ADCx_MspInit(ADC_HandleTypeDef *hadc)
{
  GPIO_InitTypeDef  GPIO_InitStruct;
...
/**
  ...
  * @retval None
  */
static void stm32f7xx_nucleo_144::ADCx_MspDeInit(ADC_HandleTypeDef *hadc)
{
  GPIO_InitTypeDef  GPIO_InitStruct;
...
/**
  ...
  * @retval None
  */
static void stm32f7xx_nucleo_144::ADCx_Init(void)
{
...
/**
  ...
  * @retval None
  */
static void stm32f7xx_nucleo_144::ADCx_DeInit(void)
{
    hnucleo_Adc.Instance   = NUCLEO_ADCx;
...
/**
  ...
  */
#ifdef JOY_ENABLED
uint8_t stm32f7xx_nucleo_144::JOY_Init(void)
{
...
/**
  ...
  * @retval None.
  */
void stm32f7xx_nucleo_144::JOY_DeInit(void)
{
    ADCx_DeInit();
}
...
/**
  ...
  */
JOYState_TypeDef stm32f7xx_nucleo_144::JOY_GetState(void)
{
